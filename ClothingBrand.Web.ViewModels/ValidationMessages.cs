namespace ClothingBrandApp.Web.ViewModels
{
    public static class ValidationMessages
    {
        ...
        {
            public const string WarehouseNameRequiredMessage = "Warehouse name is required.";
            public const string WarehouseNameMinLengthMessage = "Warehouse name must be at least 2 characters.";
            public const string WarehouseNameMaxLengthMessage = "Warehouse name cannot exceed 100 characters.";
